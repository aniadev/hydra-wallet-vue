...
export const DEFAULT_PROTOCOL_PARAMETERS: ProtocolParameters = {
...
export const DREP_DEPOSIT = '500000000' // 500 ADA

export const resolveTxFees = (
  txSize: number,
  txFeePerByte = DEFAULT_PROTOCOL_PARAMETERS.txFeePerByte,
  txFeeFixed = DEFAULT_PROTOCOL_PARAMETERS.txFeeFixed
) => {
  const fees = BigInt(txFeePerByte) * BigInt(txSize) + BigInt(txFeeFixed)
